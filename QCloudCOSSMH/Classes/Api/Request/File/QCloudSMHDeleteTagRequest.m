...
@implementation QCloudSMHDeleteTagRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
            ...
            *error = [NSError
                qcloud_errorWithCode:QCloudNetworkErrorCodeParamterInvalid
                             message:[NSString stringWithFormat:
                                                   @"InvalidArgument:paramter[tagId] is invalid (nil), it must have some value. please check it"]];
        }
        return NO;
    }
    ...
    [__pathComponents addObject:self.tagId];
