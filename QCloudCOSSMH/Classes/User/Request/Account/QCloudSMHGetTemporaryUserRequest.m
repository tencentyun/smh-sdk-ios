//
//  QCloudSMHGetTemporaryUserRequest.m
//  QCloudCOSSMH
//
...
@implementation QCloudSMHGetTemporaryUserRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudSMHTemporaryUserResult class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    NSURL *serverHost = [NSURL URLWithString:[_serverDomain stringByAppendingString:@"user/v1/temporary"]];
    ...
    if (self.sortType > QCloudSMHTemporaryUserSortNone) {
        [self.requestData setQueryStringParamter:QCloudSMHTemporaryUserSortTypeTransferToString(self.sortType%100) withKey:@"order_by"];
