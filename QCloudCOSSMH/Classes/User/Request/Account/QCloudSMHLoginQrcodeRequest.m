...
@implementation QCloudSMHLoginQrcodeRequest
- (void)dealloc {
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [__pathComponents addObject:[NSString stringWithFormat:@"%@/login/%@",self.organizationId,self.code]];
