//
//  QCloudSMHGetAuthorizedToMeDirectoryRequest.h
//  AOPKit
//
...
/**
 获取共享给我的文件夹
 */
@interface QCloudSMHGetAuthorizedToMeDirectoryRequest : QCloudSMHUserBizRequest
...
/**
 排序字段，按名称排序为 QCloudSMHSortTypeName，
