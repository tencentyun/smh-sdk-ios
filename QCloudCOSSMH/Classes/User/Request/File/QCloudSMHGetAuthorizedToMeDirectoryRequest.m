//
//  QCloudSMHGetAuthorizedToMeDirectoryRequest.m
//  AOPKit
//
...
@implementation QCloudSMHGetAuthorizedToMeDirectoryRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [__pathComponents addObject:@"received-authorization-directory"];
