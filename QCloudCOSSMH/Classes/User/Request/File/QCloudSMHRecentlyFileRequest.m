//
//  QCloudSMHRecentlyFileRequest.m
//  Pods
//
...
- (instancetype)init {
    ...
    self.sortType = QCloudSMHSortTypeVisitTime;
    return self;
}
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    NSURL *serverHost = [NSURL URLWithString:[_serverDomain stringByAppendingFormat:@"%@", [NSString stringWithFormat:@"user/v1/directory/%@/recently-used?user_token=%@",self.organizationId,self.userToken]]];
