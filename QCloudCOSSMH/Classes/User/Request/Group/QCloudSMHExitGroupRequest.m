...
@implementation QCloudSMHExitGroupRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    NSURL *serverHost = [NSURL URLWithString:[_serverDomain stringByAppendingFormat:@"%@", [NSString stringWithFormat:@"user/v1/group/%@/%@/exit",self.organizationId,self.groupId]]];
