...
@implementation QCloudSMHGetGroupInviteCodeRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    NSURL *serverHost = [NSURL URLWithString:[_serverDomain stringByAppendingFormat:@"%@", [NSString stringWithFormat:@"user/v1/invite/%@/invite-to-group/%@",self.organizationId,self.groupId]]];
