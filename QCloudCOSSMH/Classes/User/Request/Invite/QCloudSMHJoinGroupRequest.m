...
@implementation QCloudSMHJoinGroupRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    NSURL *serverHost = [NSURL URLWithString:[_serverDomain stringByAppendingFormat:@"%@", [NSString stringWithFormat:@"user/v1/invite/%@/%@/join-group",self.organizationId,self.code]]];
