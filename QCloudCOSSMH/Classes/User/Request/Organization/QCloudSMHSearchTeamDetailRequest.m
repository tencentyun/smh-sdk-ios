//
//  QCloudSMHSearchTeamDetailRequest.m
//  AOPKit
//
...
@implementation QCloudSMHSearchTeamDetailRequest
- (void)dealloc {
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudSMHSearchTeamInfo class])
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    if (self.teamId) {
        [self.requestData setQueryStringParamter:self.teamId withKey:@"team_id"];
    }
