//
//  QCloudSMHGetVirusDetectionListRequest.m
//  QCloudCOSSMH
//
...
@implementation QCloudSMHGetVirusDetectionListRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudVirusDetectionFileList class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    self.requestData.directBody = @{@"spaceItems":self.spaceItems.qcloud_modelToJSONObject}.qcloud_modelToJSONData;
