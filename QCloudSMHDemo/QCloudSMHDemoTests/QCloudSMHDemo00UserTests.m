...
//static NSString * testDirName1 = @"iosunittestDir";
//static NSString * testFileName1 = @"testFile";
//
...
//
//- (void)setUp {
//    [QCloudSMHBaseRequest setBaseRequestHost:@"https://pan.tencentsmh.cn/" targetType:QCloudECDTargetDevelop];
...
//}
//
//-(void)testQCloudSMHUpdateUserInfoRequest{
//    XCTestExpectation *expectation = [self expectationWithDescription:@"testQCloudSMHUpdateUserInfoRequest"];
//    QCloudSMHUpdateUserInfoRequest * request = [QCloudSMHUpdateUserInfoRequest new];
//    request.userToken = QCloudSMHTestTools.singleTool.getUserToken;
//    request.organizationId = QCloudSMHTestTools.singleTool.getOrgnizationId;
//    
//    request.enabled = @(YES);
//    request.nickname = @"nickname";
//    request.email = @"test@163.com";
//    request.userId = QCloudSMHTestTools.singleTool.getUserId;
//    [request setFinishBlock:^(id  _Nullable outputObject, NSError * _Nullable error) {
//        XCTAssertNotNil(error);
//        [expectation fulfill];
//    }];
//    [[QCloudSMHUserService defaultSMHUserService] updateUserInfo:request];
//    [self waitForExpectationsWithTimeout:30 handler:nil];
//}
//
...
//    req.organizationId = QCloudSMHTestTools.singleTool.getOrgnizationId;
//    req.spaceId = QCloudSMHTestTools.singleTool.getSpaceId;
//    req.path = [testDirName1 stringByAppendingString:[@"/" stringByAppendingString:[testFileName1 stringByAppendingString:@"_move"]]];
//    req.userToken =  QCloudSMHTestTools.singleTool.getUserToken;
...
//    req.dirPath = [testDirName1 stringByAppendingString:[@"/" stringByAppendingString:[testFileName1 stringByAppendingString:@"_move"]]];
//    req.spaceId = QCloudSMHTestTools.singleTool.getSpaceId;
//    req.organizationId = QCloudSMHTestTools.singleTool.getOrgnizationId;
//    req.userToken = QCloudSMHTestTools.singleTool.getUserToken;
...
//        XCTAssertNil(error);
//        XCTAssertNotNil(result);
//        XCTAssertTrue([result.paths.lastObject isEqualToString:[testFileName1 stringByAppendingString:@"_move"]]);
//        XCTAssertTrue([result.paths.firstObject isEqualToString:testDirName1]);
//        [expectation fulfill];
//    }];
...
//    req.userToken = QCloudSMHTestTools.singleTool.getUserToken;
//    req.organizationId = QCloudSMHTestTools.singleTool.getOrgnizationId;
//    req.filePath = [testDirName1 stringByAppendingString:[@"/" stringByAppendingString:[testFileName1 stringByAppendingString:@"_move"]]];
//    req.limit = 50;
